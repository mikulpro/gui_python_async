...
#  - pri snapnuti vice bloku dohromady to nakopiruje dany cog ze storage do cogs
#  - interface na pridavani cogu\
#  - prejit asi z tkinteru na kivy -> dynamicke vytvareni widgetu